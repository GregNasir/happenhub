    ...
    <div className="art-page">
      ...
      <CardGroup>
        <Card>
          ...
          <Card.Footer>
            <Button variant="primary" onClick={() => handleCategorySelect('Basketball')}>Select</Button>
          </Card.Footer>
        </Card>
        <Card>
          <Card.Img variant="top" src={hockey} />
          ...
          <Card.Footer>
            <Button variant="primary" onClick={() => handleCategorySelect('Hockey')}>Select</Button>
          </Card.Footer>
        </Card>
        <Card>
          <Card.Img variant="top" src={boxing} />
          ...
          <Card.Footer>
            <Button variant="primary" onClick={() => handleCategorySelect('Boxing')}>Select</Button>
          </Card.Footer>
        </Card>
      </CardGroup>
    </div>
